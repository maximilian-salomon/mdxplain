...
class RMSDMedianService:
    ...
    computation using the median metric for outlier-resistant RMSD values.

    Examples
    --------
    >>> service = RMSDMedianService(pipeline_data)  # doctest: +SKIP
    ...
    def __init__(self, pipeline_data: PipelineData | None) -> None:
        ...
        if pipeline_data is None:
            raise ValueError("RMSDMedianService requires pipeline_data")
    ...
    def to_reference(
        ...
        metric for outlier-resistant values.
    ...
    def frame_to_frame(
        ...
        RMSD values between frames separated by ``lag`` using the median
        metric.
    ...
    def window_frame_to_start(
        ...
        first frame and condensed via the median metric into a single RMSD
        value per window.
    ...
    def window_frame_to_frame(
        ...
        condensed using the median metric.
