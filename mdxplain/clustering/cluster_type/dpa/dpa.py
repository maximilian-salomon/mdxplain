...
class DPA(ClusterTypeBase):
    ...
    def __init__(self, Z=1, metric="euclidean", affinity='precomputed', 
                 density_algo="PAk", k_max=1000, D_thr=23.92812698, 
                 dim_algo="twoNN", blockAn=True, block_ratio=20, frac=1.0, 
                 halos=False):
        """
    ...
    def _validate_parameters(self):
        ...
        if isinstance(self.affinity, str):
            valid_affinities = ['precomputed', 'rbf', 'nearest_neighbors', 'precomputed_nearest_neighbors']
