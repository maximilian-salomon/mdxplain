...
class DPACalculator(CalculatorBase):
    ...
    def _compute_without_cache(self, data, **kwargs) -> Tuple[np.ndarray, Dict]:
        ...
        **kwargs : dict
        ...
        cluster_labels, dpa_model, computation_time = self._perform_clustering(data, parameters)
        metadata = self._build_metadata(data, cluster_labels, dpa_model, parameters, computation_time)
    ...
    def _extract_parameters(self, kwargs):
        ...
        """
        required_params = ['Z', 'metric', 'affinity', 'density_algo', 
                          'k_max', 'D_thr', 'dim_algo', 'blockAn', 
                          'block_ratio', 'frac']
    ...
    def _build_metadata(self, data, cluster_labels, dpa_model, parameters, computation_time):
        """
    ...
    def _get_error_densities(self, dpa_model):
        ...
        """
        if hasattr(dpa_model, 'err_densities_') and dpa_model.err_densities_ is not None:
