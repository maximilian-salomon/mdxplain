...
class DBSCANCalculator(CalculatorBase):
    ...
    def _compute_without_cache(self, data, **kwargs) -> Tuple[np.ndarray, Dict]:
        ...
        **kwargs : dict
        ...
        cluster_labels, dbscan_model, computation_time = self._perform_clustering(data, eps, min_samples)
        metadata = self._build_metadata(data, cluster_labels, dbscan_model, eps, min_samples, computation_time)
    ...
    def _build_metadata(self, data, cluster_labels, dbscan_model, eps, min_samples, computation_time):
        """
        ...
        metadata = self._prepare_metadata(hyperparameters, data.shape, n_clusters, n_noise)
