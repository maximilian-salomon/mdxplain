...
class LandscapePlotter:
    ...
    def plot(
        ...
        if clustering_name:
            LandscapeStylingHelper.add_central_legend(fig, cluster_colors, show_clusters, fig_width, right_inch)
    ...
    def _plot_single_landscape(
        ...
        if energy_values:
            LandscapeRenderingHelper.plot_energy_background(ax, data_x, data_y, bins, temperature, xlim, ylim)
        else:
        ...
        # Set axis styling
        LandscapeStylingHelper.set_axis_labels(ax, dim_x, dim_y, xaxis_label, yaxis_label)
