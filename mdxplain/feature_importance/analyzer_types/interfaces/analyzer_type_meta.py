...
"""
Metaclass for analyzer types to enable string representation of classes.

Allows analyzer_types.DecisionTree to return "decision_tree" directly
...
class AnalyzerTypeMeta(ABCMeta):
    """
    Metaclass for analyzer types to enable string representation of classes.

    This allows analyzer_types.DecisionTree to return "decision_tree" directly
    instead of requiring instantiation or method calls.
